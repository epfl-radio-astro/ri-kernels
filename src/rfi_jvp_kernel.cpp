...
ffi::Future calc_rfi_jvp_cpu_impl_tmpl(
  ...
  return parallel_for(
      thread_pool, n_bl,
      [n_int_inv, a1_tensor, a2_tensor, rfi_amp_fine_tensor,
       ...
       rfi_grad_tensor](int64_t i_bl_start, int64_t i_bl_end) mutable {
        ...
        Tensor3D<std::complex<T> *> rfi_grad_tensor_th(
            &rfi_grad_tensor(i_bl_start, 0, 0), n_bl_this_chunk,
            rfi_grad_tensor.shape[1], rfi_grad_tensor.shape[2]);

        if constexpr (std::is_same_v<T, float>) {
          RI_KERNELS_EXPORT_AND_DISPATCH_T(rfi_jvp_kernel_opt_f32)
          (n_int_inv, a1_tensor_th, a2_tensor_th, rfi_amp_fine_tensor,
           rfi_amp_fine_grad_tensor, rfi_phase_tensor, rfi_phase_grad_tensor,
           rfi_grad_tensor_th);
        } else {
          RI_KERNELS_EXPORT_AND_DISPATCH_T(rfi_jvp_kernel_opt_f64)
          (n_int_inv, a1_tensor_th, a2_tensor_th, rfi_amp_fine_tensor,
           rfi_amp_fine_grad_tensor, rfi_phase_tensor, rfi_phase_grad_tensor,
           rfi_grad_tensor_th);
        }
...
ffi::Future calc_rfi_jvp_cpu_f32_impl(
    ffi::ThreadPool thread_pool,
    ffi::BufferR1<ffi::S32> a1, ffi::BufferR1<ffi::S32> a1_sorter,
    ffi::BufferR1<ffi::S32> a1_start, ffi::BufferR1<ffi::S32> a2,
    ffi::BufferR1<ffi::S32> a2_sorter, ffi::BufferR1<ffi::S32> a2_start,
...
ffi::Future calc_rfi_jvp_cpu_f64_impl(
    ffi::ThreadPool thread_pool,
    ffi::BufferR1<ffi::S32> a1, ffi::BufferR1<ffi::S32> a1_sorter,
    ffi::BufferR1<ffi::S32> a1_start, ffi::BufferR1<ffi::S32> a2,
    ffi::BufferR1<ffi::S32> a2_sorter, ffi::BufferR1<ffi::S32> a2_start,
...
calc_rfi_jvp_cpu_f32(XLA_FFI_CallFrame *call_frame);
extern "C" RI_KERNELS_API XLA_FFI_Error *
calc_rfi_jvp_cpu_f64(XLA_FFI_CallFrame *call_frame);
