// The three analytic handlers share the interpolation operand order, with a
// scalar duration in the time-offset slot. Options are static FFI attributes.
...
RI_ANALYTIC_RETURN RI_ANALYTIC_IMPL(, f32)(
  ...
  return RI_ANALYTIC_DISPATCH<0, float, ffi::C64, ffi::F32>(
      RI_ANALYTIC_CONTEXT_PASS, a1, a2, pair, tiles, amp, amp, phase, delay,
      wf, sf, gt, st, dnu, duration, freq, *out, out, segments, terms, cubic_terms);
}
...
RI_ANALYTIC_RETURN RI_ANALYTIC_IMPL(_jvp, f32)(
  ...
  return RI_ANALYTIC_DISPATCH<1, float, ffi::C64, ffi::F32>(
      RI_ANALYTIC_CONTEXT_PASS, a1, a2, pair, tiles, amp, dot, phase, delay,
      wf, sf, gt, st, dnu, duration, freq, *out, out, segments, terms, cubic_terms);
}
...
RI_ANALYTIC_RETURN RI_ANALYTIC_IMPL(_transpose, f32)(
  ...
  return RI_ANALYTIC_DISPATCH<2, float, ffi::C64, ffi::F32>(
      RI_ANALYTIC_CONTEXT_PASS, a1, a2, pair, tiles, amp, amp, phase, delay,
      wf, sf, gt, st, dnu, duration, freq, cot, out, segments, terms, cubic_terms);
}
